...
try:
    ...
    center_depth_value = depth_image_resized[200, 300]
    ...
    mask = np.where((depth_image_resized > depth_threshold_near) & 
                    (depth_image_resized < depth_threshold_far), 150, 255).astype(np.uint8)
    ...
    alpha = 5.0  # Strong contrast control
