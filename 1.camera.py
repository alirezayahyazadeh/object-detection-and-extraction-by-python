...
try:
    while True:
        ...
        # Step 7: Apply a threshold to the grayscale image to create a binary image
        # Adjust the threshold value (127) based on the object's color and lighting conditions
